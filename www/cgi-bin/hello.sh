...
<head>
<meta charset="UTF-8">
<title>Hello Bash - Webserv</title>
...
<div class="cgi-result">
  <span class="cgi-badge">GET · Bash CGI</span>
  <h1>🔧 Hello from Bash!</h1>
HTML
echo "  <div class=\"cgi-row\"><span class=\"label\">Method</span><span class=\"value\">$REQUEST_METHOD</span></div>"
echo "  <div class=\"cgi-row\"><span class=\"label\">Server</span><span class=\"value\">$SERVER_NAME:$SERVER_PORT</span></div>"
echo "  <div class=\"cgi-row\"><span class=\"label\">Query</span><span class=\"value\">${QUERY_STRING:-none}</span></div>"
echo "  <div class=\"cgi-row\"><span class=\"label\">Status</span><span class=\"value\" style=\"color:#15803d;font-weight:700;\">✅ Bash CGI is working!</span></div>"
cat << HTML
